  ...
  async function refresh() {
    ...
    try {
      ...
      const { data: s, error: se } = await supabase
        .from("suppliers")
        .select("id,tenant_id,type,legal_name,trade_name,document,state_registration,notes,name")
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Field label="Nome fantasia">
            <Input
              ...
              onChange={(e) => setSupplier((p) => (p ? { ...p, trade_name: e.target.value } : p))}
          ...
          <Field label="Razão social">
            <Input
              ...
              onChange={(e) => setSupplier((p) => (p ? { ...p, legal_name: e.target.value } : p))}
          ...
          <Field label="Documento (CPF/CNPJ)">
            <Input
              ...
              onChange={(e) => setSupplier((p) => (p ? { ...p, document: e.target.value } : p))}
